...
require.register("big-sky-code-mirror/lib/codemirror.js", function(module, exports, require){
...
require.register("big-sky-code-mirror/index.js", function(module, exports, require){
module.exports = require("./lib/codemirror.js");
...
require.register("shaunxcode-ouija/index.js", function(module, exports, require){
...
require.register("shaunxcode-ouija/vendor/jquery-ui-touch-punch.js", function(module, exports, require){
/*!
...
require.register("jjclark1982-markdown/lib/markdown.js", function(module, exports, require){
...
require.register("bibliomaniac/vendor/backbone.js", function(module, exports, require){
//     Backbone.js 0.9.9
...
require.register("bibliomaniac/vendor/backbone.localStorage.js", function(module, exports, require){
/**
...
require.register("bibliomaniac/vendor/jquery.splitter.js", function(module, exports, require){
/*!
...
require.register("bibliomaniac/lib/data/Book/Model.js", function(module, exports, require){
// Generated by CoffeeScript 1.3.3
(function() {
  var ChaptersCollection, Model,
  ...
  Model = (function(_super) {
    ...
    Model.prototype.initialize = function() {
      return this.chapters = new ChaptersCollection(this.get("toc"), {
        url: "" + (this.url()) + "/chapters"
      });
    };
...
require.register("bibliomaniac/lib/data/Book/Collection.js", function(module, exports, require){
// Generated by CoffeeScript 1.3.3
(function() {
  var Collection,
    __hasProp = {}.hasOwnProperty,
  ...
  Collection = (function(_super) {
    ...
    Collection.prototype.url = "/books";
...
require.register("bibliomaniac/lib/data/Book/Chapter/Model.js", function(module, exports, require){
// Generated by CoffeeScript 1.3.3
(function() {
  var Model,
    __hasProp = {}.hasOwnProperty,
...
require.register("bibliomaniac/lib/data/Book/Chapter/Collection.js", function(module, exports, require){
// Generated by CoffeeScript 1.3.3
(function() {
  var Collection,
    __hasProp = {}.hasOwnProperty,
...
require.register("bibliomaniac/lib/App.js", function(module, exports, require){
// Generated by CoffeeScript 1.3.3
(function() {
  var App, BooksCollection, ChaptersPanelView, EditorView, PreviewView;

  window.vendorRequire = function(f) {
    return require("../vendor/" + f + ".js");
  };

  window.dataRequire = function(f) {
    return require("./data/" + f + ".js");
  };

  window.appRequire = function(f) {
    return require("./" + f + ".js");
  };
  ...
  App = {
    init: function() {
      return $(function() {
        ...
        this.chaptersPanel = new ChaptersPanelView({
          el: $("#chapters"),
          collection: this.booksCollection
        });
        this.chaptersPanel.render();
        ...
        return this.booksCollection.fetch();
      });
    }
  };
...
(function() {
  ...
  View = (function(_super) {
    ...
    View.prototype.addAll = function() {
      var _this = this;
      this.$booksCombo.html("");
      this.collection.each(function(book) {
        return _this.addOne(book);
      });
      return this.$booksCombo.change();
    };

    View.prototype.addOne = function(book) {
      return this.$booksCombo.append($("<option />").prop({
        value: book.get("id"),
        text: book.get("title")
      }));
    };
    ...
    View.prototype.renderChapters = function(book) {
      ...
      this.$chapters.html("");
      return book.chapters.each(function(chapter) {
        var cview;
        _this.chapterViews.push(cview = new ChapterView({
          model: chapter
        }));
        return _this.$chapters.append(cview.render().$el);
      });
    };
...
(function() {
  ...
  View = (function(_super) {
    ...
    View.prototype.open = function() {
      Backbone.trigger("OpenChapter", this.model);
...
require.register("bibliomaniac/lib/Editor/View.js", function(module, exports, require){
// Generated by CoffeeScript 1.3.3
(function() {
  var View,
    __hasProp = {}.hasOwnProperty,
  ...
  View = (function(_super) {
    ...
    View.prototype.initialize = function() {
      var _this = this;
      return this.listenTo(Backbone, {
        OpenChapter: function(chapter) {
          return _this.openChapter(chapter);
        }
      });
    };
    ...
    View.prototype.render = function() {
      ...
      this.editor = codemirror(this.$el[0], {
        ...
        onScroll: function() {
          Backbone.trigger("EditorScrollTop", _this.$scroller.scrollTop());
          if (_this.$scroller.scrollTop() === (_this.$scroller[0].scrollHeight - _this.$scroller[0].offsetHeight)) {
            return Backbone.trigger("EditorScrollAtBottom");
          }
        }
      });
      this.$scroller = this.$(".CodeMirror-scroll");
      this.$scrollingPanes = this.$(".CodeMirror, .CodeMirror-scroll, .CodeMirror-scrollbar");
      this.listenTo(Backbone, "AppResized", function() {
        _this.$scrollingPanes.css({
          height: _this.$el.innerHeight(),
          width: _this.$el.innerWidth()
        });
    ...
    View.prototype.openChapter = function(chapter) {
      ...
      return this.chapter.fetch({
        success: function() {
          return _this.editor.setValue(chapter.get("source"));
        }
      });
    };
...
(function() {
  ...
  View = (function(_super) {
    ...
    View.prototype.render = function() {
      var _this = this;
      this.$el.html("Markdown preview");
      this.listenTo(Backbone, "EditorChanged", this.renderPreview);
      this.listenTo(Backbone, "EditorScrollTop", this.setScroll);
      this.listenTo(Backbone, "EditorScrollAtBottom", this.scrollToBottom);
      this.listenTo(Backbone, "ActiveBook", function(book) {
        return _this.activeBook = book;
      });
      this.listenTo(Backbone, "OpenChapter", function(chapter) {
    ...
    View.prototype.renderPreview = function(md) {
      ...
      if (this.activeBook) {
        totalEnv = this.activeBook.get("env");
        env = us.extend(env, totalEnv["*"], totalEnv[this.activeChapter.get("id")] || {}, {
          title: "##" + (this.activeChapter.get("title"))
        });
      }
      return this.$content.html(markdown.toHTML(us.template(md, env)));
    };

    View.prototype.setScroll = function(amt) {
      return this.$el.scrollTop(amt);
    };
...
require.alias("big-sky-code-mirror/index.js", "bibliomaniac/deps/code-mirror/index.js");

require.alias("component-underscore/index.js", "bibliomaniac/deps/underscore/index.js");

require.alias("shaunxcode-ouija/index.js", "bibliomaniac/deps/ouija/index.js");
require.alias("shaunxcode-ouija/vendor/jquery-ui-touch-punch.js", "bibliomaniac/deps/ouija/vendor/jquery-ui-touch-punch.js");
