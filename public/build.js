...
// Generated by CoffeeScript 1.3.3
(function() {
  var App, ChaptersPanelView, EditorView, PreviewView;
  ...
  App = {
    init: function() {
      return $(function() {
        ...
        return console.log("Start the bibliomania!");
      });
    }
  };
  ...
  View = (function(_super) {
    ...
    View.prototype.render = function() {
      ...
      this.editor = codemirror(this.$el[0], {
        ...
        lineWrapping: true,
        onChange: function() {
          return Backbone.trigger("EditorChanged", _this.editor.getValue());
        },
        onScroll: function() {
...
(function() {
  ...
  View = (function(_super) {
    ...
    View.prototype.renderPreview = function(md) {
      return this.$el.html(markdown.toHTML(us.template(md, {
